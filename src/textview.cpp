...
{
    QString fileName(QFileDialog::getSaveFileName(this, tr("Save ASCII export"), QString(), tr("Text Files (*.txt);;All Files (*)")));
...
void SvgView::saveMe()
{
    QString fileName(QFileDialog::getSaveFileName(this, tr("Save SVG export"), QString(), tr("Svg Files (*.txt);;All Files (*)")));
