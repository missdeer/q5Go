...
struct Player
{
    ...
    bool has_nmatch_settings()
    {
        return nmatch_settings != "No match conditions";
    }
    bool operator==(const Player &other) const
    {
        return (info == other.info && name == other.name && idle == other.idle && rank == other.rank && play_str == other.play_str &&
                obs_str == other.obs_str && extInfo == other.extInfo && won == other.won && lost == other.lost && country == other.country &&
                nmatch_settings == other.nmatch_settings && rated == other.rated && address == other.address && mark == other.mark &&
