...
public:
    ...
    gamedb_model(bool);
    void clear_list();
    void apply_filter(const QString &p1, const QString &p2, const QString &event, const QString &dtfrom, const QString &dtto);
...
extern bit_array match_games(const std::vector<unsigned> &, const go_pattern &, std::vector<gamedb_model::cont_bw> &conts, coord_transform);
