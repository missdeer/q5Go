...
public:
    MainWindow(QWidget *parent, go_game_ptr, const QString opener_scrkey = QString(), GameMode mode = modeNormal, time_settings ts = time_settings());
    virtual ~MainWindow();
    ...
    void setTimes(int btime, const QString &bstones, int wtime, const QString &wstones, bool warn_b, bool warn_w, int);
...
public:
    MainWindow_GTP(QWidget *parent, go_game_ptr, QString opener_scrkey, const Engine &program, const time_settings &, bool b_comp, bool w_comp);
    MainWindow_GTP(
        QWidget *parent, go_game_ptr, game_state *, QString opener_scrkey, const Engine &program, const time_settings &, bool b_comp, bool w_comp);
    MainWindow_GTP(QWidget *parent,
                   go_game_ptr,
