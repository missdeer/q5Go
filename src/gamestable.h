...
struct Game
{
    ...
    {
        return (nr == other.nr && wname == other.wname && wrank == other.wrank && bname == other.bname && brank == other.brank &&
                bname == other.bname && brank == other.brank && mv == other.mv && Sz == other.Sz && H == other.H && K == other.K && By == other.By &&
                FR == other.FR && ob == other.ob);
    }
