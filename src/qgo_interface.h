...
public:
    ...
    QString get_bplayer()
    {
        return QString::fromStdString(m_game->info().name_b);
    }
    QString get_wplayer()
    {
        return QString::fromStdString(m_game->info().name_w);
    }
    void set_adj(bool a)
    {
        adjourned = a;
    ...
    {
        return QString::number(m_game->info().komi);
    }
    void dec_mv_counter()
    {
        mv_counter--;
    ...
    const std::vector<text_piece> &comments()
    {
        return m_comments;
    }
