...
GreeterWindow::GreeterWindow(QWidget *parent) : QMainWindow(parent), ui(new Ui::GreeterWindow)
{
    ui->setupUi(this);
    ...
    connect(ui->quitButton, &QAbstractButton::clicked, [](bool) { client_window->quit(); });
